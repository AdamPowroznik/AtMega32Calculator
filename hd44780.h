...
/* D4 */
#define SET_OUT_LCD_D4  DDRA  |=  _BV(PA2)
#define SET_LCD_D4      PORTA |=  _BV(PA2)
#define CLR_LCD_D4      PORTA &= ~_BV(PA2)

/* D5 */
#define SET_OUT_LCD_D5  DDRA  |=  _BV(PA3)
#define SET_LCD_D5      PORTA |=  _BV(PA3)
#define CLR_LCD_D5      PORTA &= ~_BV(PA3)

/* D6 */
#define SET_OUT_LCD_D6  DDRA  |=  _BV(PA4)
#define SET_LCD_D6      PORTA |=  _BV(PA4)
#define CLR_LCD_D6      PORTA &= ~_BV(PA4)

/* D7 */
#define SET_OUT_LCD_D7  DDRA  |=  _BV(PA5)
#define SET_LCD_D7      PORTA |=  _BV(PA5)
#define CLR_LCD_D7      PORTA &= ~_BV(PA5)
